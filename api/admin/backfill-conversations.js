...
module.exports = async (req, res) => {
  ...
  try {
    while (Date.now() - started < TIME_BUDGET_MS) {
      // Deliberately unscoped: walks every DM-capable account in the
      // workspace, across all four organisations. That is the owner's intent —
      // one pooled identity graph, not a Farmers-Fightback-only one.
