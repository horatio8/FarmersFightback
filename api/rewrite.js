...
const CARROLL_PROMPT = [
  ...
  "- The email MUST keep both of its demands: that the Premier APOLOGISE to the farming families his government targeted, and that he ORDER AN INDEPENDENT INVESTIGATION into the targeting of farmers. Never soften, hedge, merge or drop either demand, and never turn them into a mere question or request for comment.",
  "- Frame Lily D'Ambrosio's resignation, if mentioned, as insufficient: she resigned without apologising and the laws, the department and its conduct remain. She must not be treated as a scapegoat; the campaign holds the Government of Victoria responsible for targeting farmers, not one departed minister alone. Do not present the resignation as a resolution.",
  "- Tone is firm, direct and serious, but never abusive, threatening or personal. No insults, no profanity, no accusations of criminality, and no threats of any kind.",
  "- The supporting material you may draw on is limited to: the former Energy Minister resigned without apologising; the laws remain on the books and the department reports to the Premier's government; government staff turned up unannounced and uninvited at farms across the state; staff brought a security escort to press a farmer in her eighties about VNI West; Greg Baldwin called triple zero to report trespassers on his own property and was the one charged; on 27 April 2026 the Director of Public Prosecutions withdrew every charge against him without explanation; farming families have worked their land for generations. Do not invent anything beyond these.",
