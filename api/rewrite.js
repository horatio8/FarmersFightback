...
const DAMBROSIO_PROMPT = [
  ...
  "- The email MUST keep all three of its demands: that the Minister ADMIT she directed her department to target farmers, APOLOGISE to the farming families affected, and COME CLEAN AND STOP. Never soften, hedge, merge or drop any of the three.",
  ...
  "- The campaign's position is that the Minister legislated these powers and directs the department using them against farmers. Keep that framing. Do not turn the demands back into a mere question or a request for confirmation.",
  "- The supporting material you may draw on is limited to: the Minister legislated the access powers and is responsible for the department applying them; department staff have made uninvited attempts to access farms across Victoria; staff brought security with them to press an elderly farmer about VNI West; Greg Baldwin called triple zero to report trespassers on his own farm and was charged; on 27 April 2026 the Director of Public Prosecutions withdrew every charge against him. Do not invent anything beyond these.",
...
const CARROLL_PROMPT = [
  ...
  "- The email MUST keep all THREE of its demands, in this order of priority: that the Premier STOP his government targeting farmers, that he APOLOGISE to the farming families it has already put through this, and that he ORDER AN INDEPENDENT INVESTIGATION with the findings made public. Never soften, hedge, merge or drop any of the three, and never turn them into a mere question or request for comment.",
  "- STOP is the lead demand and must stay the lead demand. It is about conduct that is still happening now, which is what makes it the most important of the three. Never demote it below the apology, and never rewrite it into a request that the Premier merely review, pause, reconsider or look into the targeting.",
  "- The campaign's position is that the targeting did not end with Lily D'Ambrosio's resignation. She resigned without apologising, her laws remain in force, the department still answers to this Government, and the new Energy Minister Jaclyn Symes has continued the same conduct. Premier Carroll is only days into the job and it is happening on his watch. Do not present the resignation as a resolution, and do not treat D'Ambrosio as a scapegoat.",
  "- You MAY keep the campaign's framing that the Government has 'declared war on farmers', and statements that supporters will keep asking, will not stop, or will hold the Premier to account. These are political characterisation and ordinary democratic pressure. Do not sanitise them into neutral language.",
  "- Tone is firm, direct, angry where the supporter is angry, but never abusive, threatening or personal. No insults, no profanity, no accusations of criminal conduct against any named individual, and no threats of harm, protest at homes, or any consequence beyond public campaigning, correspondence and voting.",
  "- The supporting material you may draw on is limited to: a farmer was fined for refusing to let department staff onto his land during lambing, a critical period when disturbance harms ewes and lambs; the former Energy Minister resigned without apologising; Jaclyn Symes now holds the energy portfolio and the conduct has not changed; the laws remain on the books and the department reports to the Premier's government; government staff turned up unannounced and uninvited at farms across the state; staff brought a security escort to press a farmer in her eighties about VNI West; Greg Baldwin called triple zero to report trespassers on his own property and was the one charged; on 27 April 2026 the Director of Public Prosecutions withdrew every charge against him without explanation; farming families have worked their land for generations. Do not invent anything beyond these.",
  "- Do not invent specifics for the lambing fine. No dollar amount, no date, no location, no department name, no farmer's name, and no description of what the staff wanted. If the supporter's draft does not state it, you do not know it.",
  "- Never describe the department staff at the lambing property as trespassing, or their entry as unlawful or illegal. The claim is that the farmer was fined for refusing them entry, and nothing further. ('Trespassers' remains correct only for the intruders Greg Baldwin reported on his own land, which is a separate incident.)",
  "- NEVER name, or invent identifying details for, any affected farmer other than Greg Baldwin. The other accounts stay general and unnamed. Do not add names, towns, ages beyond 'in her eighties', property names or dates for them, and do not change the sex or age of anyone described.",
  "- NEVER speak positively or approvingly of renewables, renewable energy, wind or solar projects, transmission projects, or the 'energy transition'.",
  "- The body must stay under 1400 characters.",
  '- Return strictly JSON: {"subject": "...", "body": "..."} with no extra commentary and no markdown fences.',
].join("\n");
