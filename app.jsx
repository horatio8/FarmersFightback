...
// /every — the escalation donation page. The story in one line:
// 11,000+ emails have gone to the Premier's office and the fines are still
// landing, so the next phase is scale — recruit every Australian. The core of
...
const EVERY_AUSTRALIAN_PAGE = {
  ...
  lede: "More than 11,000 of you have emailed the Premier's office demanding this government stop targeting farming families. That message was sent one name at a time — and the fines are still landing. A Premier can ignore an inbox. He cannot ignore the whole country. So this is the next phase: we will recruit every Australian to this fight, and your support is what makes it possible.",
  achievements: {
    heading: "The plan: recruit every Australian.",
    image: "/assets/uploads/stories/story-5.jpg",
    imageAlt: "A farmer stands with his back to camera in a paddock, facing a line of transmission towers.",
    imageFallback: "/assets/uploads/parliament-house-group.jpg",
    bullets: [
      ...
      "So the fight goes to every letterbox, every feed and every town hall in the country — city and bush, farmer or not.",
      "Every Australian who joins makes this a problem no Premier can file away. That's how the targeting ends.",
    ],
    kicker: "They have billions. We'll have Australia.",
  },
};
...
function App() {
  ...
  else if (page === "every") view = (
    <DonorPage
      override={EVERY_AUSTRALIAN_PAGE}
      variant="won"
      hideNav
      hideTopBanner
      whereFirst={false}
      autoScrollToWidget={false}
      storiesUrl="content/dambrosio-stories.json"
      storiesCta="Chip in — help recruit every Australian"
    />
  );
